                            ...
                            @if($language)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <select name="parent_parent_id" id="parent_parent_id" class="form-control">
...
@push('script')
            ...
            if (id) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        $("#parent_parent_id").html(result);
                    }
                });
            }
            
            var id = $("#parent_parent_id").val();
            if (id) {
                $.ajaxSetup({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{route('admin.sub-sub-sub-category.getSubSubCategory')}}',
                    data: {
                        id: id
                    },
                    success: function (result) {
    ...
    <script>
        ...
        $('#parent_parent_id').on('change', function () {
            var id = $(this).val();
            if (id) {
                $.ajaxSetup({
                    headers: {
